...
void test_map()
{
	...
	/* Size */
	{
		...
		stl_map.insert(std::make_pair(42, std::string("Represent")));
		ft_map.insert(ft::make_pair(42, std::string("Represent")));
	...
	/* Insert single */
	{
		...
		stl_map.insert(std::make_pair(42, std::string("La famille")));
		ft_map.insert(ft::make_pair(42, std::string("La famille")));
	...
	/* Insert hint */
	{
		...
		stl_map.insert(++(stl_map.begin()), std::make_pair(42, std::string("Nice")));
		ft_map.insert(++(ft_map.begin()), ft::make_pair(42, std::string("Nice")));
	...
	/* Value comp */
	{
		...
		bool stl_res = stl_key(std::make_pair(99, std::string("End")), std::make_pair(42, std::string("Noice")));
		bool ft_res = ft_key(ft::make_pair(99, std::string("End")), ft::make_pair(42, std::string("Noice")));
